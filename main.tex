...
\documentclass[letterpaper,9pt]{extarticle} % Use 'letterpaper' for US Letter size
%\documentclass[a4paper,9pt]{extarticle}

% Packages
\usepackage[utf8]{inputenc} % For input encoding
\usepackage{geometry} % For page margins
\geometry{margin=0.75in} % Set margins for letterpaper size
...
\noindent
\textbf{R\&D Data Scientist at Migros} \hfill 04-2023/Present % Company name and location
\begin{itemize}
...
\noindent
\textbf{Reporting and Data Analytics Specialist at Sony} \hfill 01-2023/04-2023 % Project or organization name and location
\begin{itemize}
...
\textbf{Data Scientist at Greenmusk} \hfill 03-2022, 12-2022 % Club or organization name and location
\begin{itemize}
...
\noindent
% Club or Organization Experience
\textbf{Growth Analyst at Glocalzone} \hfill 01-2021, 05-2021 % Club or organization name and location
\begin{itemize}
